...
public class DimensionConverter {
    ...
    public static Point convertPoint(vec3d point3D) {
    ...
    public static void rotateAxisX(vec3d p, boolean CW, double degrees) {
    ...
    public static void rotateAxisY(vec3d p, boolean CW, double degrees) {
    ...
    public static void rotateAxisZ(vec3d p, boolean CW, double degrees) {
